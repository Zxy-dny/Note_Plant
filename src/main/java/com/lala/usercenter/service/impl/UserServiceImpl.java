package com.lala.usercenter.service.impl;
...
import com.lala.usercenter.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "lala";

    @Override
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode) {
        // 1. 校验
        // 导入apache.commons.lang3 利用 StringUtils中的方法代替 userAccount == null || userPassword == null || checkPassword == null
